...
const steps: Step[] = [
  { id:1, title:'Define', desc:'Set goals & plan', icon:<IconDefine/> },
  { id:2, title:'Donate', desc:'Funds allocated', icon:<IconDonate/> },
  { id:3, title:'Produce', desc:'Local women craft kits', icon:<IconProduce/> },
  { id:4, title:'Distribute', desc:'Kits delivered & logged', icon:<IconDistribute/> },
  { id:5, title:'Educate', desc:'Hygiene learning sessions', icon:<IconEducate/> },
];
