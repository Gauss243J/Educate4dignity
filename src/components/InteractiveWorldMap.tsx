            ...
            geographies.map((geo: any) => {
              ...
              return (
                <Geography
                  ...
                  style={{
                    default: {
                      fill: isRose ? (isSelected ? "var(--rose-600)" : "var(--rose-300)") : "#e5e7eb",
                      stroke: isDRC ? "var(--rose-700)" : isRose ? "var(--rose-500)" : "#ffffff",
                    ...
                    hover: {
                      fill: isRose ? "var(--rose-500)" : selectable ? "#f3f4f6" : "#f1f5f9",
                      stroke: isDRC ? "var(--rose-700)" : isRose ? "var(--rose-600)" : "#d1d5db",
                      strokeWidth: isDRC ? (isSelected ? 2 : 1.4) : isRose ? 0.9 : 0.4,
                      outline: "none",
                      filter: isRose ? "drop-shadow(0 0 5px rgba(190,18,60,0.55))" : "none",
                    },
                    pressed: {
                      fill: isRose ? "var(--rose-600)" : "#e2e8f0",
                      stroke: isDRC ? "var(--rose-800)" : isRose ? "var(--rose-700)" : "#cbd5e1",
